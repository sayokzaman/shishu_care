...
async function askBot(userMessage: string, history: Message[]): Promise<string> {
  const data = await sendRequest('/api/chatbot/chat', 'POST', {
    message: userMessage,
    history,
  } as any);
  return data.reply;
...
export default function ChatbotScreen() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '0',
      role: 'bot',
      text: 'Hello! I\'m ShishuCare\'s Myth Buster, powered by AI. Ask me anything about child health myths in Bangladesh. Try questions like "Is honey safe for babies?" or "Do vaccines cause autism?"',
      timestamp: now(),
    },
  ]);
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#FFFFFF' }} edges={['top']}>
      <Header title="Chatbot" emoji="🤖" secondaryText="Fact-checks child health myths" />
